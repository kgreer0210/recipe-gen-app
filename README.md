...
The application uses the **Next.js 15 App Router**.
...
```
*Note: `SUPABASE_SERVICE_ROLE_KEY` is required for the rate-limit check API route which needs to bypass RLS to reliably increment counters via RPC.*
